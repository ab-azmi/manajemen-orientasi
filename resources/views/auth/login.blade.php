    ...
    <x-auth-card>
        ...
        {{-- <form method="POST" action="{{ route('login') }}">
            ...
            <div class="flex items-center justify-end mt-4">
                ...
                <a href="{{ route('register') }}" class="inline-flex items-center px-4 py-2 bg-transparent border border-gray-800 rounded-md font-semibold text-xs text-black uppercase tracking-widest hover:bg-gray-700 active:bg-gray-900 hover:text-white focus:outline-none focus:border-gray-900 focus:ring ring-gray-300 disabled:opacity-25 transition ease-in-out duration-150 ml-3">
                    {{ __('Register') }}
                </a>
            </div>
        </form> --}}
            ...
            <form action="{{ route('login') }}" autoComplete="off" method="post">
                ...
                <div class="flex flex-col mb-2">
                    <div class="flex relative ">
                        ...
                        <input type="email" id="sign-in-email" name="email" value="{{ old('email') }}" required autofocus
                ...
                <div class="flex flex-col mb-6">
                    <div class="flex relative ">
                        ...
                        <input type="password" id="sign-in-email" name="password" required
                            class=" rounded-r-lg flex-1 appearance-none border border-gray-300 w-full py-2 px-4 bg-white text-gray-700 placeholder-gray-400 shadow-sm text-base focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent"
