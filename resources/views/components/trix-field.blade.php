...
<trix-editor id="{{ $id }}" input="{{ $id }}_input" {{ $attributes->merge(['class' => 'trix-content rounded-md shadow-sm
    border-gray-300 focus:border-transparent focus:ring focus:ring-purple-600 focus:ring-opacity-50']) }}
    x-data="{
    upload(event) {
